...
export const Users = () => {
  ...
  useEffect(() => {
    ...
    const getAll = async () => {
      let res = await fetch("http://31.187.72.67/auth/all ", {
        method: "GET",
      });
      if (res.status == 200) {
        res = await res.json();
        ...
        {data.map((user) => {
          return (
            ...
            >
              ...
              <img src={user.image?user.image:"https://res.cloudinary.com/dbymvhk8x/image/upload/v1684949619/unknown_wm4koi.png"}></img>
